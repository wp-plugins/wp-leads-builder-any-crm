...
The manage shortcodes page displays the list of shortcodes. Click 'Edit' to edit and enable/disable the fields.  
...
= Form Settings =
   ...
   Form Setting are comes under the form builder module. There you can choose the form type, set texts for error message
...
* Enable contact form 7 in the settings page to create contact shortcode 
...
Ninja and gravity form support [Go pro now](https://www.smackcoders.com/wp-leads-builder-any-crm-pro.html)
...
* Blank admin page problem was fixed.
